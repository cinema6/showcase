...
function EditTargeting({
    ...
    return (<form onSubmit={handleSubmit}>
        <div className="form-group">
            <label htmlFor="adTitle-input">
                ...
                <OverlayTrigger
                    placement="bottom"
                    overlay={<Tooltip>
                        These are the categories you selected for your app on the app store
                    </Tooltip>}
                >
        ...
        <div className="form-group">
            ...
            <div
                className="select-target-options hidden-sm hidden-xs"
                data-toggle="buttons"
            >
                <label
                ...
                >
                    <MultiCheckbox
                        value={value(age)}
                        onChange={age.onChange}
                        option={TARGETING.AGE.YOUNG_ADULTS}
                    /> Adults <small>(18-35)</small>
                </label>
                <label
                    className={classnames('btn btn-default', {
                ...
                >
                    <MultiCheckbox
                        value={value(age)}
                        onChange={age.onChange}
                        option={TARGETING.AGE.ADULTS}
                    /> Adults <small>(35+)</small>
                </label>
            </div>
            {/* swapping mobile with vertical class*/}
            <div
                className="select-target-options-vertical visible-sm visible-xs"
                data-toggle="buttons"
            >
                <label
                    className={classnames('btn btn-default', {
            ...
            >
                ...
                >
                    <input
                        ...
                        checked={value(gender) === TARGETING.GENDER.ALL}
                    /> Everyone
                </label>
                <label
                    className={classnames('btn btn-default', {
                ...
                >
                    <input
                        type="radio"
                        {...gender}
                        value={TARGETING.GENDER.FEMALE}
                        checked={value(gender) === TARGETING.GENDER.FEMALE}
                    /> Women
                </label>
                <label
                    className={classnames('btn btn-default', {
                ...
                >
                    <input
                        type="radio"
                        {...gender}
                        value={TARGETING.GENDER.MALE}
                        checked={value(gender) === TARGETING.GENDER.MALE}
                    /> Men
                </label>
            </radiogroup>
            {/* swapping mobile with vertical class */}

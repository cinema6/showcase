...
describe('campaign utils', function() {
    describe('campaignUpdateFromData({ productData, targeting })', () => {
        ...
        beforeEach(function() {
            ...
            result = campaignUpdateFromData({ productData, targeting });
        });

        it('should return a campaign update', function() {
        ...
        describe('if a campaign is passed', function() {
            ...
            beforeEach(function() {
                ...
                result = campaignUpdateFromData({ productData, targeting }, campaign);
            });

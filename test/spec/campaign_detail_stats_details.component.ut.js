...
describe('CampaignDetailStatsDetails', function() {
    ...
    it('should give each button\'s wrapper the active class when appropriate', function() {
        const seven = this.component.find('.switch-chart-range li').at(0);
        const thirty = this.component.find('.switch-chart-range li').at(1);

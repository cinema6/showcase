...
describe('Campaign Detail', function() {
    ...
    describe('rendering',function(){
        ...
        describe('the InstallTrackingSetupModal', function() {
            ...
            beforeEach(function() {
                this.modal = component.find(InstallTrackingSetupModal);
            });
            ...
            it('should pass the show property', function() {
                expect(this.modal.props().show).toBe(component.props().page.showInstallTrackingInstructions);
            });

            it('should pass the campaignId', function() {
                expect(this.modal.props().campaignId).toBe(component.props().campaign.id);
            });
        ...
        describe('the AdPreviewModal', function() {
            beforeEach(function() {
                this.this.modal = component.find(AdPreviewModal);
            });

            it('should exist', function() {
                expect(this.this.modal.length).toEqual(1, 'AdPreviewModal not rendered');
            });

            it('should pass the show property', function() {
                expect(this.this.modal.props().show).toBe(component.props().page.showAdPreview);
            });

            it('should pass the campaign', function() {
                expect(this.this.modal.props().campaign).toEqual(component.props().campaign);
            });

            describe('onClose()', function() {
                beforeEach(function() {
                    this.this.modal.props().onClose();
                });

                it('should hide the this.modal', function() {
